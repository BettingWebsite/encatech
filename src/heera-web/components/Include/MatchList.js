        ...
        <table class="table table-bordered1 font-weight-normal">
          <tbody>
            ...
            <tr>
              <td>
                <p className="text">
                  11. Once our exchange give username and password it is your
            ...
            <tr>
              <td>
                <p className="text">
                  13. Warning:- live scores and other data on this site is
                  sourced from third party feeds and may be subject to time
                  delays and/or be inaccurate. If you rely on this data to place
                  bets, you do so at your own risk. Our exchange does not accept
                  responsibility for loss suffered as a result of reliance on
                  this data.
                </p>
              </td>
            </tr>
            <tr>
              <td>
                <p className="text">
                  14. Our exchange is not responsible for misuse of client id.
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                <p className="text1">1.1 Complete session valid in test.</p>
              </td>
            </tr>{" "}
            <tr>
              <td>
                <p className="text1">
                  1.2 Session is not completed for ex:- India 60 over run
                  session Ind is running in case India team declares or all-out
                  at 55 over next 5 over session will be continue in England
                  inning.
                </p>
              </td>
            </tr>
            <tr>
              <td>
                <p className="text1">
                  1.3 1st day 1st session run minimum 25 over will be played
                  then result is given otherwise 1st day 1st session will be
                  deleted.
                </p>
              </td>
            </tr>{" "}
            <tr>
              <td>
                <p className="text1">
                  1.5 1st day total run minimum 80 over will be played then
                  result is given otherwise 1st day total run will be deleted.
                </p>
              </td>
            </tr>{" "}
            <tr>
