...
class Sidebar extends Component {
  ...
  render() {
   ...
   var sports_casino1 = (
    <li
      className="nav-item"
    >
      <Link to="/casino-queen" className="nav-link">
  ...
  var sports_casino3 = (
    <li
      className="nav-item"
    >
      <Link to="/aaa-card" className="nav-link">
        <span style={{ cursor: "pointer" }}>Bollywood Casino</span>
      </Link>
    </li>
  );
  var sports_casino4 = (
    <li
      className="nav-item"
    >
      <Link to="/worli" className="nav-link">
        <span className="" style={{ cursor: "pointer" }}>
          Worli
        </span>
      </Link>
  ...
  var sports_casino7 = (
    <li className="nav-item ">
      <Link to="/casino/dt-one-day" className="nav-link">
   ...
   // ................
    ...
    return (
      <ul className="sidebar navbar-nav">
        ...
        <li className="casino2 collapse show" style={{padding:"5px 10px"}}>
          <ul className="tree" style={{ marginTop: "-3px" }}>
            <li>
              Football
              <div
                className="expander"
