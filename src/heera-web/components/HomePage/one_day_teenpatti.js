...
class Index extends Component {
    ...
    axios
      ...
      .then((resp) => {
        ...
        if (resp.success === true) {
          ...
          axios
            .get(baseUrl + "/casino-result-teen-patti", { headers })
            .then((resp) => {
  ...
  componentDidMount() {
    ...
    socket.on("FromAPI2", (data) => {
      this.setState({ casinodt20: data });
      this.callMatchOddsApi(data);
      // console.log(data);
    });
                ...
                <div className="col-md-9 featured-box-detail">
                  <div className="coupon-card">
                    <div className="game-heading d-flex flex-row justify-content-between">
                      <span className="card-header-title">BigBash</span>
                    </div>
                        ...
                        <table className="coupon-table table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <span>
                                  <strong>{this.state.nation_b}</strong>
                                </span>
                              </td>
