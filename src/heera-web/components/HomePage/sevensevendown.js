...
class Index extends Component {
  ...
  handleSubmitSession = (event) => {
    ...
    axios
      .post(baseUrl + "/createbetusersession", savebet, { headers })
      .then((resp) => {
        var resp = resp.data;
        if (resp.success === true) {
          this.setState({
  ...
  callMatchOddsApi = () => {
    ...
    axios.get(baseUrl + "/casino", { headers }).then((resp) => {
      ...
      if (resp.success === true) {
        ...
        // this.callMatchOddsApi()
        axios
          .get(baseUrl + "/userbetlist/" + getResult1[37].mid, { headers })
          .then((resp) => {
            var resps = resp.data;
            var profit12 = 0;
            var profit13 = 0;
      ...
      if (this.state.getResults !== undefined) {
        for (let i = 0; i < this.state.getResults.length; i++) {
          if (this.state.getResults[i].selection_id === teamOneSelectionId) {
            ...
            this.state.getResults[i].selection_id === teamTwoSelectionId
          ) {
      ...
      for (let i = 0; i < this.state.getResults.length; i++) {
        ...
        html.push(
          <tr>
            ...
            <td style={{ textAlign: "center" }}>
              {" "}
              {this.state.getResults[i].profit}{" "}
            </td>
          </tr>
        );
      }
                ...
                <tr>
                  ...
                  >
                    ...
                    <a
                      ...
                      className="btn btn-success btn_dyn"
                      value={value_10}
                      onClick={this.handleButtonsNewClick.bind(this, value_10)}
                    >
                      {button_10}
                    </a>
                  </td>
  ...
  render() {
    ...
    if (
      ...
      for (var i = 0; i < this.state.casinodt20.length; i++) {
        newarray.push(
          <span className="ball-runs ">{this.state.casinodt20[i].result}</span>
        );
      }
                  ...
                  <div className="coupon-card">
                    <div className="game-heading">
                      ...
                      <span className="float-right m-r-10">
                        Round ID: 200508174628
                      </span>
                    </div>
                    <div className="card-content">
                      <div class="casino_video">
                        <span class="blinking2">
                          {" "}
                      ...
                      <div className=" mb-4 main-market market-bf">
                        <table className="coupon-table table table-bordered">
                          <thead>
                            <tr>
                              <th>
                                <span className="h6">Match Odds</span>
                              </th>
                              <th> &nbsp;</th>
                              <th> &nbsp;</th>
                              <th className="text-center  box-w1 back">
                                {" "}
                                BACK
                              </th>
                              <th
                                className="text-center  box-w1 lay"
                                style={{
                            ...
                            <tr>
                              ...
                              <td className="box-w1  back2">
                                <button className="bet-sec ">
                                  <span className="odd layprice"> 0</span>0
                                </button>
                              </td>
                              <td className="box-w1  back2">
                                <button className="bet-sec ">
                      ...
                      <div className=" mb-4 main-market market-bf">
                        <table className="coupon-table table table-bordered">
                          <thead>
                            <tr>
                              <th>
                                <span className="h6">Odd-Even</span>
                              </th>
                              <th> &nbsp;</th>
                              <th> &nbsp;</th>
                              <th className="text-center  box-w1 back">
                        ...
                        <div id="menu1" className=" tab-pane fade">
                          <div className="form-group">
                            <label className="form-check-label mr-2">
                              <input className="" type="checkbox" /> Show bet
                              Info
                            </label>

                            <label className="form-check-label">
                              <input className="" type="checkbox" /> Show bets
                              for this event
                            </label>
                          </div>
                        </div>
