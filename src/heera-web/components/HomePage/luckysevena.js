...
//       ======================== hushi code end 0 ==========================
    ...
    getl7bOdds = () => {
        axios.get("http://13.126.49.41:3000/getdata/l7a").then((res) => {
            if (res.data) {
    ...
    getl7brOdds = () => {
        axios.get("http://13.126.49.41:3000/getresult/l7a").then((resp) => {
            if (resp.data) {
                                        ...
                                        <div className="card-content">
											...
											<div className="divsmall col-md-9">
                                                ...
                                                <iframe className="live_video"
                                                        src="https://c_n.casinovid.in/ddiamond/lucky7a/"
