...
class Slots extends Component {
  ...
  //     let OneTouch = response.data.filter(
  //       (item, index) =>
  //         (item.product === "OneTouch" || item.category === "Video Slots") &&
  //         index < 14
  //     );
  //     let Microgaming = response.data.filter(
  //       (item, index) =>
  //         (item.product === "Microgaming" || item.category === "Video Slots") &&
  //         index < 14
  //     );
  //     let Spadegaming = response.data.filter(
  //       (item, index) =>
  //         (item.product === "Spadegaming" || item.category === "Video Slots") &&
  //         index < 14
  //     );
  ...
  receivedData() {
    ...
    const postData = slice.map((item, index) => (
      <React.Fragment>
        <div className="col-3 col-sm-2 px-3" key={index}>
        ...
        <div>
          <div id="wrapper">
            ...
            <div id="content-wrapper">
              ...
              <div className="row game_img_man px-3">{this.state.postData}</div>
            </div>
          </div>
