    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <Modal.Body>
                    <table className="table table-bordered1 table-sm mt-1">
                        <thead className="table-borderless">
                            <tr>
                                <th scope="col" className="bg2 text-white text-center">Event Type</th>
                                <th scope="col" className="bg2 text-white text-center">Event Name</th>
                                <th scope="col" className="bg2 text-white text-center">Trade</th>
                            </tr>
                        </thead>
