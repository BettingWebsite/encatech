    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <ul className="nav nav-tabs nav_top_mobile">
                    <li className="nav-item">
                        <a href="/inplay/cricket" className={`nav-link ${isActive === "/inplay/cricket" ? 'nav-link1' : ''}`}>
                            In-play
                        </a>
                    </li>
                    <li className="nav-item router-link-exact-active">
                        <a href="/matches/cricket" className={`nav-link ${isActive === "/matches/cricket" ? 'nav-link1' : ''}`} style={{ borderTop: "2px solid #fff" }}>
                            Sports
                        </a>
                    </li>
                    <li className="nav-item">
